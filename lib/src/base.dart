...
import 'mtt_javascript_channel.dart';
...
// TODO: use an id by webviews to be able to manage multiple webviews
...
class FlutterWebviewPlugin {
  ...
  /// - [withZoom]: enable zoom on webviews
  ...
  /// For example, when webviews is redirected to a specific URL, you want to intercept
  /// this process by stopping loading this URL and replacing webviews by another screen.
  ///   Android only settings:
  /// - [displayZoomControls]: display zoom controls on webviews
  /// - [withOverviewMode]: enable overview mode for Android webviews ( setLoadWithOverviewMode )
  /// - [useWideViewPort]: use wide viewport for Android webviews ( setUseWideViewPort )
  /// - [ignoreSSLErrors]: use to bypass Android/iOS SSL checks module_my_study.g. for self-signed certificates
  Future<void> launch(
    String url, {
    Map<String, String>? headers,
    Set<MTTJavascriptChannel> javascriptChannels = const <MTTJavascriptChannel>{},
  ...
  /// Execute Javascript inside webviews
  ...
  /// Checks if webviews can navigate back
